...
class TokenEmbedding(keras.layers.Embedding):
    ...
    def call(self, inputs):
        return tf.identity(self.embeddings)

def get_model(node_size,rel_size,node_hidden,rel_hidden,triple_size,batch_size,n_attn_heads = 2,dropout_rate = 0,gamma = 3,lr = 0.005,depth = 2):
